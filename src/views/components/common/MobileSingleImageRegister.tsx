...
const photoPreview = async (f: File, props: SINGLE_IMAGE_REGISTER) => {
    ...
    if(file !== null) {
        ...
        const preview = document.getElementById("mobilePreviewArea") as HTMLDivElement;
        let previewImage = document.getElementById("mobilePreviewImage");
        ...
        reader.onload = function() {
            ...
            if(reader.result !== null) {
                ...
                img.setAttribute("id", "mobilePreviewImage");
...
/**
 * 画像のドラッグ&ドロップ + 画像のプレビュー表示用関数(スマホ版)
 * @returns 
 */
const MobileSingleImageRegister: React.FC<SINGLE_IMAGE_REGISTER> = (props) => {
        ...
        <div id="dragDropArea" ref={fileArea} onClick={() => handleFileClick()}>
            <div className="drag-drop-inside">
                ...
                <div id="mobilePreviewArea">
                    {
                        props.data ? 
                            <img src={props.data} id="mobilePreviewImage" className="c_imagesize" />
                        :
                            ''
                    }
                </div>
...
export default MobileSingleImageRegister